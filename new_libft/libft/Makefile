...
#    Updated: 2017/01/20 12:29:34 by sescolas         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

OBJS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_countwords.o \
	   ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprime.o \
	   ft_isprint.o ft_itoa.o ft_lstadd.o ft_exp.o \
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_countwords.c \
	   ...
	   ft_isprint.c ft_itoa.c ft_lstadd.c ft_exp.c \
	   ...
	   ft_strdup.c ft_strequ.c ft_strfind.c ft_striter.c ft_striteri.c \
